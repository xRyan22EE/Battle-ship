...
def UpdateGameScreen(window: pygame.surface) -> None:
    global game_started, game_over, resetGameGrid, run_game, player1_values, player2_values # Access the global game_started variable
...
def handle_events() -> None:
    global run_game, yCooForShots, xCooForShots, game_over, player1_values, player2_values
